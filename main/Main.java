...
//                            System.out.println(it.getName() + " a dat damage " + secondDamage + " lui " + players.get(j).getName());
//                            System.out.println(players.get(j).getName() + " a dat damage " + firstDamage + " lui " + it.getName());
